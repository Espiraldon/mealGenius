              ...
              barGroups: [
                BarChartGroupData(x: 0, barRods: [
                  BarChartRodData(
                      color: primaryColor,
                      toY: double.parse(
                          '${myIngredients.where((element) => element.type == IngredientType.fruit).toList().fold(0, (previousValue, element) => previousValue + element.number)}'))
                ]),
                BarChartGroupData(x: 1, barRods: [
                  BarChartRodData(
                      color: primaryColor,
                      toY: double.parse(
                          '${myIngredients.where((element) => element.type == IngredientType.vegetable).toList().fold(0, (previousValue, element) => previousValue + element.number)}'))
                ]),
                BarChartGroupData(x: 2, barRods: [
                  BarChartRodData(
                      color: primaryColor,
                      toY: double.parse(
                          '${myIngredients.where((element) => element.type == IngredientType.meal).toList().fold(0, (previousValue, element) => previousValue + element.number)}'))
                ]),
                BarChartGroupData(x: 3, barRods: [
                  BarChartRodData(
                      color: primaryColor,
                      toY: double.parse(
                          '${myIngredients.where((element) => element.type == IngredientType.feculent).toList().fold(0, (previousValue, element) => previousValue + element.number)}'))
                ]),
              ],
